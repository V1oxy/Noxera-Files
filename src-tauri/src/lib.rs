...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::tracker_boards::rename_tracker_field_option,
            ...
            commands::tracker_tasks::add_tracker_task_local_file_version,
            commands::tracker_tasks::restore_tracker_task_local_file_version,
            commands::tracker_tasks::remove_tracker_task_local_file,
            commands::tracker_tasks::open_tracker_task_local_file,
            commands::tracker_tasks::open_tracker_task_local_file_version,
            commands::tracker_tasks::attach_tracker_task_link,
            commands::tracker_tasks::add_tracker_task_adhoc_link,
            commands::tracker_tasks::detach_tracker_task_link,
            commands::tracker_tasks::add_tracker_task_comment,
            commands::tracker_tasks::delete_tracker_task_comment,
