...
export const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "tracker.copyLink": "Copy Link",
    "tracker.linkCopied": "Link copied",
    ...
    "tracker.event.statusChanged": "Status changed: {from} → {to}",
    "tracker.event.priorityChanged": "Priority changed: {from} → {to}",
    "tracker.event.dueChanged": "Deadline changed",
    "tracker.event.assigneeChanged": "Assignee changed to {to}",
    "tracker.event.customerChanged": "Customer changed to {to}",
    "tracker.event.projectChanged": "Project changed",
    "tracker.event.completedAtChanged": "Completion date changed",
    "tracker.event.titleChanged": 'Renamed to "{to}"',
    "tracker.event.fileAdded": 'File added: "{name}"',
    "tracker.event.fileRemoved": 'File removed: "{name}"',
    "tracker.event.fileVersionUpdated": '"{name}" updated: version {from} → {to}',
    ...
    "tracker.event.duplicated": 'Duplicated from "{from}"',
  ...
  ru: {
    ...
    "tracker.fieldCompletedAt": "Дата завершения",
    ...
    "tracker.copyLink": "Копировать ссылку",
    "tracker.linkCopied": "Ссылка скопирована",
    ...
    "tracker.event.statusChanged": "Статус изменён: «{from}» → «{to}»",
    "tracker.event.priorityChanged": "Приоритет изменён: {from} → {to}",
    "tracker.event.dueChanged": "Дедлайн изменён",
    "tracker.event.assigneeChanged": "Ответственный изменён: {to}",
    "tracker.event.customerChanged": "Заказчик изменён: {to}",
    "tracker.event.projectChanged": "Проект изменён",
    "tracker.event.completedAtChanged": "Дата завершения изменена",
    "tracker.event.titleChanged": "Переименована в «{to}»",
    "tracker.event.fileAdded": "Добавлен файл «{name}»",
    "tracker.event.fileRemoved": "Файл «{name}» удалён из задачи",
    "tracker.event.fileVersionUpdated": "Для файла «{name}» доступна новая версия: {from} → {to}",
    ...
    "tracker.event.duplicated": "Дублировано из «{from}»",
